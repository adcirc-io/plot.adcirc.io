...
this["adcirc"]["templates"]["fort63options"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
this["adcirc"]["templates"]["node_list"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper;

  return "<div id=\""
    + container.escapeExpression(((helper = (helper = helpers.id_node_list || (depth0 != null ? depth0.id_node_list : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"id_node_list","hash":{},"data":data}) : helper)))
    + "\" class=\"node-list\"></div>";
},"useData":true});
...
this["adcirc"]["templates"]["node_picker"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"form-group form-group-sm form-item form-item-last\">\n    <label class=\"col-sm-5 control-label\">\n        Node:\n    </label>\n    <div class=\"col-sm-7 control-content\">\n        <input id=\""
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\" class=\"form-control\" type=\"number\" min=\"1\" max=\""
